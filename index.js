...
app.post("/api/update-profile", profilePictureUpload.single("profilePicture"), async (req, res) => {
...
app.post("/api/noteUpload", noteUpload.single("uploadFile"), async (req, res) => {
